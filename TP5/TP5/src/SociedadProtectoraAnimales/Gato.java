...
public class Gato extends Thread{
    ...
    public Gato(int nroEspecieAnimal, Comedero comedor, int nroAnimal){
    ...
    public void run() {
        ...
        while(!comio){
            try {
                ...
                if(comio){
                    System.out.println("El gato"+ nroAnimal  +" entro a comer");
                }else{
                    System.out.println("El gato"+ nroAnimal  +" espera");
                    this.comedor.esperar();
                }
                if(comio){
                    Thread.sleep(1250);
                    System.out.println("El gato"+ nroAnimal  +" termino de comer");
